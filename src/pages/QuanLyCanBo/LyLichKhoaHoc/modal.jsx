...
const ModalItem = () => {
  ...
  const { modalActive, selectedLyLichKhoaHoc, pageSize, pageNumber } =
  ...
  const onRecordInputChange = (key, event) => {
    if (key) {
      ...
      dispatch(
        lyLichKhoaHocSlice.actions.updateSelectedLyLichKhoaHocInput(clone)
      );
    }
  };
  ...
  return (
    <CustomeModal
      ...
      title={
        selectedLyLichKhoaHoc?.id ? "Cập nhật dữ liệu" : "Thêm mới dữ liệu"
      }
      okText="Chấp nhận"
      cancelText="Từ chối"
    >
