...
const DanhSachKhenThuongKyLuat = () => {
    ...
    const pageHeader = {
      breadcrumb: [
        ...
        {
          title: type===LOAI_KHEN_THUONG_KY_LUAT.KHEN_THUONG?"Quản lý thi đua, khen thưởng":"Quản lý kỷ luật",
          href: type===LOAI_KHEN_THUONG_KY_LUAT.KHEN_THUONG?"/chinh-sach/quan-ly-thi-dua-khen-thuong":"/chinh-sach/quan-ly-ky-luat"
        },
        {
          title: type===LOAI_KHEN_THUONG_KY_LUAT.KHEN_THUONG?"Danh sách khen thưởng":"Danh sách kỷ luật",
        },
      ],
    };
    const { danhSachKhenThuongKyLuats, isLoading, totalItem, pageNumber, pageSize } =
      useSelector((state) => state.danhSachKhenThuongKyLuats);
  const columns = [
    ...danhSachKhenThuongKyLuats&&danhSachKhenThuongKyLuats[0]?.can_bo?CanBoColumns:DonViColumns,
    {
      title: "Công cụ",
      key: "tool",
      align: "center",
