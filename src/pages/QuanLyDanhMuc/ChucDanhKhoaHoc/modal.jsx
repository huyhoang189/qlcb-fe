...
const ModalItem = () => {
  ...
  const { modalActive, selectedChucDanhKhoaHoc, pageSize, pageNumber } =
  ...
  const onRecordInputChange = (key, event) => {
    if (key) {
      ...
      dispatch(
        chucDanhKhoaHocSlice.actions.updateSelectedChucDanhKhoaHocInput(clone)
      );
    }
  };
  ...
  return (
    <CustomeModal
      ...
      title={
        selectedChucDanhKhoaHoc?.id ? "Cập nhật dữ liệu" : "Thêm mới dữ liệu"
      }
      okText="Chấp nhận"
      cancelText="Từ chối"
    >
