...
const pageHeader = {
  breadcrumb: [
    ...
    {
      title: "Quản lý hình thức khen thưởng",
    },
  ],
};
...
const QuanLyHinhThucKhenThuong = () => {
  const dispatch = useDispatch();
  const { hinhThucKhenThuongs, isLoading, totalItem, pageNumber, pageSize } =
  ...
  const handlePaginationChange = (current, pageSize) => {
    dispatch(
      hinhThucKhenThuongSlice.actions.getHinhThucKhenThuongs({
        keyword,
        pageSize: pageSize,
        pageNumber: current,
      })
...
export default QuanLyHinhThucKhenThuong;
