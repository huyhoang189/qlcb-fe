...
const pageHeader = {
  breadcrumb: [
    ...
    {
      title: "Quản lý danh mục ngoại ngữ",
    },
  ],
};
...
const QuanLyNgoaiNgu = () => {
  const dispatch = useDispatch();
  const { ngoaiNgus, isLoading, totalItem, pageNumber, pageSize } =
    useSelector((state) => state.ngoaiNgus);
  ...
  const handlePaginationChange = (current, pageSize) => {
    dispatch(
        ngoaiNguSlice.actions.getNgoaiNgus({
        keyword,
        pageSize: pageSize,
        pageNumber: current,
      })
